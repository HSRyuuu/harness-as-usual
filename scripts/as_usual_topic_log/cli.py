...
def build_parser() -> argparse.ArgumentParser:
    ...
    complete_task.add_argument("--mode", default="", help="test-required | no-test")
    complete_task.add_argument("--test-target", default="")
    complete_task.add_argument("--red-evidence", default="", help="regression RED evidence; required for bug fixes")
    complete_task.add_argument("--green-evidence", default="", help="passing-test evidence for a test-required task")
    complete_task.add_argument("--expected-result", default="")
    complete_task.add_argument("--result", default="")
    complete_task.add_argument("--no-test-reason", default="", help="why a no-test task skips tests (config, generated, throwaway)")
