...
- task 리뷰는 requirements 충족과 quality/safety를 한 번에 보는 단일 리뷰이며 상세는 `execute/task-<N>-review.md`, cleanup 리뷰 상세는 `clean-up/review-result-<type>.md`에 YAML frontmatter `verdict`와 함께 기록한다.
