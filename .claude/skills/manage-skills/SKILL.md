...
| ---------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| verify-runtime-surface | Verifies that runtime-facing surfaces do not contain maintainer/plugin-development guidance | `hooks/**`, `as-usual-rules/**`, public `skills/**`, `templates/**`, `scripts/**`, public docs |
