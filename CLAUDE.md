...
| Record/completion/routing rule files | `as-usual-rules/logging-rules.md`, `as-usual-rules/completion-rules.md`, `as-usual-rules/routing-rules.md` | single-source owners for record-layer rules, completion judgment, and routing; referenced by core-workflow and skills |
